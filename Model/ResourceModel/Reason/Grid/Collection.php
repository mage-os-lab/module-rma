...
namespace MageOS\RMA\Model\ResourceModel\Reason\Grid;

use MageOS\RMA\Model\ResourceModel\Reason\Collection as ReasonCollection;
...
class Collection extends ReasonCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        string $mainTable = 'rma_reason',
        string $resourceModel = \MageOS\RMA\Model\ResourceModel\Reason::class,
